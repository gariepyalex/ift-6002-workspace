...
public class InstrumentResponseAssembler {
    ...
    public Instrument fromResponse(InstrumentResponse response) throws InvalidResponseException {
        InstrumentResponseValidator validator = new InstrumentResponseValidator();
