...
public class OperationResource extends Resource {
    ...
    private static final String NO_PATIENT_FOUND_CODE = "INT002";
    private static final String NO_PATIENT_FOUND_MESSAGE = "The patient does not exist";

    private static final String ALREADY_USED_SERIAL_CODE = "INT011";
    ...
    private static final String NO_INSTRUMENT_FOUND_MESSAGE = "Could not find instrument in the operation";
    ...
    public Response createOperation(@Context UriInfo uri, OperationResponse operationResponse) {
        try {
            ...
            return error(NO_PATIENT_FOUND_CODE, NO_PATIENT_FOUND_MESSAGE);
        }
    }
    ...
    public Response createInstrument(@PathParam("noIntervention") String noIntervention, @Context UriInfo uri,
        ...
        try {
            ...
            return error(ALREADY_USED_SERIAL_CODE, ALREADY_USED_SERIAL_MESSAGE);
        } catch (NoSuchElementException e) {
            return error(NO_ELEMENT_FOUND_CODE, NO_OPERATION_FOUND_MESSAGE);
        }
    }
    ...
    public Response modifyInstrumentStatus(@PathParam("noIntervention") String noIntervention,
        ...
        try {
            ...
            return error(NO_ELEMENT_FOUND_CODE, NO_INSTRUMENT_FOUND_MESSAGE);
        }
    }
}
