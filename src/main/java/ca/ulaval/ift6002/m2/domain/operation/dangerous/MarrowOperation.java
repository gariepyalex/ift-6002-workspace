...
public class MarrowOperation extends DangerousOperation {
    public MarrowOperation(Description description, Surgeon surgeon, Date date, Room room, OperationStatus status,
            Patient patient) {
